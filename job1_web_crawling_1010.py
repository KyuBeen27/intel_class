...
#url = 'https://news.naver.com/main/main.naver?mode=LSD&mid=shm&sid1=1'

headers = {"User-agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.0.0 Safari/537.36"}
#resp = requests.get(url,headers=headers)

# for i in range(6):
#     resp=requests.get('https://news.naver.com/main/main.naver?mode=LSD&mid=shm&sid1=1')
...
#     titles.apend(re.compile('[^가-힣[a-z][A-Z]').sub(' ',title_tag.text)
#
# print(titles)
# print(len(titles))
